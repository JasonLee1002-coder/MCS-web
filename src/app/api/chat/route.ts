...
2. **麥味登 MWD（揚秦國際集團）** — 首間智能店型於桃園大興店開幕，第二站忠孝新生店。導入「智能取餐櫃」，APP 點餐掃 QR Code 直接取餐免排隊。AI 預測模組分析尖峰時段數據提前預製加速出餐，KDS 廚房顯示系統串接。智取櫃採租賃制，138 萬加盟金含設備。還有 PEANUTS/Snoopy 聯名主題店
