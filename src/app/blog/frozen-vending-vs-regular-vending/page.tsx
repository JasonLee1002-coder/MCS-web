        ...
        <div className="space-y-7 text-slate-300 leading-relaxed">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  ...
                  ['電費（月）', 'NT$800–1,200', 'NT$1,200–2,000'],
                  ['設備售價', 'NT$80,000–150,000', 'NT$180,000–320,000'],
                  ['月租費', 'NT$3,000–5,000', 'NT$5,500–9,500'],
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                num: '04',
                title: '附近有便利商店嗎？',
                content: '距離 7-11 / 全家 5 分鐘步行以內：一般飲料零食機競爭力弱（消費者會走去超商），但冷凍熱食機仍有差異化（超商微波要錢且麻煩）。距離超過 10 分鐘：任何機型都有需求。',
              },
              {
                num: '05',
                title: '預算和回收期期望是多少？',
          ...
          <div className="space-y-4">
            {[
              {
                q: 'Q：冷凍販賣機一定比較耗電嗎？',
                a: '比一般冷藏機稍多，但差距不大。銓幻元冷凍機月均電費 NT$1,400–1,800，比同容量冷藏機多約 NT$400–600。以月收入 NT$40,000 的場域來說，電費佔比不到 5%，不是選機的關鍵因素。',
              },
              {
                q: 'Q：冷凍食材難取得嗎？',
              ...
              {
                q: 'Q：一般販賣機可以改裝成冷凍機嗎？',
                a: '技術上不建議。冷凍需要特殊壓縮機、隔熱設計、溫控系統，改裝成本接近新機。若有需求，建議直接租賃冷凍機，月租費 NT$5,500 起，不需要前期投入。',
              },
            ].map(({ q, a }) => (
          ...
          <div className="rounded-xl p-5 my-6 text-center" style={{ background: '#0f2744', border: '1px solid rgba(255,107,53,0.3)' }}>
            ...
            <a href="/solutions/frozen-microwave?utm_source=blog&utm_medium=article-bottom&utm_campaign=vending-comparison"
