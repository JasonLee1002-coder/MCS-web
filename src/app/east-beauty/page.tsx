...
const TRANSLATIONS = {
  zh: {
    ...
    thousand: {
      ...
      pillarsTitle2: "三大基礎",
      pillars: [
        { icon:"💰",title:"低門檻開店",desc:"每家店只需貸款 100 萬即可啟動。\n小坪數（15–30坪）、少人力（2人）、設備自助化，大幅壓低固定成本，讓加盟者快速回本、獲利。",tag:"貸款 100萬起" },
  ...
  en: {
    ...
    thousand: {
      ...
      tagline: "NT$1M loan per store · 2 staff · open in 3 days",
      stats: [
        { num:"1M",unit:"NT$",label:"Min. loan per store" },
        { num:"2",unit:"staff",label:"Min. to operate" },
        { num:"1000",unit:"stores",label:"Expansion target" },
        { num:"1B",unit:"NT$",label:"Brand valuation goal" },
      ],
      pillarsLabel: "THREE PILLARS",
      pillarsTitle1: "The Three Foundations of ",
      pillarsTitle2: "1,000 Stores",
      pillars: [
        { icon:"💰",title:"Low Entry Barrier",desc:"Each store launches with just NT$1M loan.\nSmall footprint (15–30 ping), minimal staff (2), self-service equipment — dramatically lower fixed costs for fast ROI.",tag:"From NT$1M loan" },
      ...
      flywheelSteps: [
        { icon:"🏪",title:"Franchise Opens",desc:"NT$1M loan · 2 staff" },
      ...
      franchiseItems: [
        "NT$1M loan to launch — low barrier",
      ...
      franchiseBottom: "Goal: 1,000 stores nationwide · NT$1B brand valuation · Taiwan's strongest AI restaurant chain",
    },
    satellite: {
      eyebrow: "GRABOX SATELLITE NETWORK",
  ...
  ja: {
    ...
    thousand: {
      ...
      title: "10億NT$",
      sub: "千店計画",
      tagline: "1店舗100万NT$ローン · 2名運営 · 3日開業",
      stats: [
        { num:"100",unit:"万NT$",label:"最低出店ローン" },
        { num:"2",unit:"名",label:"最低運営人数" },
        { num:"1000",unit:"店舗",label:"展開目標" },
        { num:"10",unit:"億NT$",label:"ブランド評価目標" },
      ],
      pillarsLabel: "THREE PILLARS",
      pillarsTitle1: "千店を支える",
      pillarsTitle2: "3つの基盤",
      pillars: [
        { icon:"💰",title:"低参入障壁",desc:"各店舗は100万NT$のローンだけで開始可能。\n小規模（15〜30坪）・少人数（2名）・セルフサービス設備で固定費を大幅削減し、加盟者の早期回収・利益化を実現。",tag:"100万NT$ローンから" },
      ...
      flywheelSteps: [
        { icon:"🏪",title:"フランチャイズ開業",desc:"100万NT$ローン · 2名スタート" },
      ...
      franchiseBottom: "目標：全国1,000店舗 · ブランド評価10億NT$ · 台湾最強AIレストランチェーン",
    },
    satellite: {
