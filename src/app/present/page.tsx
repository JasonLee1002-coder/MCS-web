...
const slides = [
  ...
  },
  {
    id: "scene-food",
    title: "應用場景：餐飲連鎖",
    subtitle: "早餐店 · 連鎖餐飲 · 飯店",
    image: "/images/cases/mwd/mwd-snoopy-storefront.jpg",
    bullets: [
      "智取櫃分流尖峰人潮，APP 點餐直接取餐",
      "KDS 廚房顯示系統串接，AI 預測加速出餐",
      "會員積分增加顧客黏著度",
      "非尖峰時段販售輕食飲料，24H 營收不斷",
      "租賃制導入，降低加盟門檻",
    ],
    bg: "from-[#1a2a4a] to-mcs-blue-dark",
  },
  {
    id: "scene-temple",
    title: "應用場景：宮廟文化",
    subtitle: "數位功德箱 · 3D神明動畫 · 行動支付",
    image: "/images/cases/temple/shilin-front.jpg",
    bullets: [
      "傳統廟宇造型 × 觸控螢幕互動",
      "信用卡 / 行動支付捐獻功德金",
      "3D 神明動畫互動，吸引年輕信眾",
  ...
  },
  {
    id: "scene-hotel",
    title: "應用場景：旅宿觀光",
    subtitle: "自助 Check-in · 客房服務 · 多國語言",
    image: "/images/illustrations/kiosk.png",
    bullets: [
      "自助 Check-in/out Kiosk，減少櫃台人力",
      "中/英/日/韓/越 多國語言介面",
      "客房樓層：日用品、飲品智能販賣機",
      "信用卡/現金/行動支付 + 發票列印",
      "停車繳費功能整合",
  ...
  },
  {
    id: "scene-retail",
    title: "應用場景：零售 · 企業 · 工廠",
    subtitle: "幸福企業方案 · 員工福利 · 24H自助",
    image: "/images/illustrations/vending.png",
    bullets: [
      "企業大樓 / 工廠員工智慧福利櫃",
      "整合員工卡、福委會系統",
      "工業區 24H 飲食需求（移工友善多語言）",
      "百貨商場智慧販賣專櫃",
      "數據分析優化商品組合與行銷策略",
    ],
    bg: "from-mcs-blue-dark to-[#1a2a4a]",
  ...
  },
  {
    id: "why-mcs",
    title: "為什麼選 MCS？",
    subtitle: "軟硬體一體 · 台灣製造 · AI 持續進化",
    image: "",
    bullets: [
      "AI 深度整合，不只是硬體設備",
      "100% 台灣設計製造，售後服務即時",
      "軟硬體一體交付，免自行整合",
      "OEM/ODM 品牌客製，少量多樣彈性生產",
      "雲端管理 + AI 數據分析，越用越聰明",
      "全台到府安裝 + 教育訓練",
    ],
    bg: "from-mcs-blue-dark to-[#1a2a4a]",
...
const qaKnowledge: Record<string, string> = {
  "價格": "GraBox 智取櫃依規格與客製需求報價，歡迎聯繫我們取得專屬方案與優惠。",
  "交期": "依規格與數量彈性排程，我們會提供最佳交貨方案，歡迎洽詢。",
