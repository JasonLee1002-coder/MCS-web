...
const slides = [
  ...
  { id: "scene-food", title: "餐飲連鎖", icon: "🍳" },
  { id: "scene-temple", title: "宮廟文化", icon: "🏯" },
  { id: "scene-hotel", title: "旅宿觀光", icon: "🏨" },
  { id: "scene-retail", title: "零售企業", icon: "🏢" },
  { id: "scene-japan", title: "國際市場", icon: "🇯🇵" },
  { id: "why-mcs", title: "為什麼選MCS", icon: "💡" },
