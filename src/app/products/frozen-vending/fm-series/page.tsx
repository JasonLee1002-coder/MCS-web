...
const KEY: SeriesKey = 'frozen-microwave'
const SLUG = 'fm-series'

export const metadata: Metadata = {
  title: { absolute: '冷凍微波智能販賣機 FM 系列：3 款型號規格比較 | 銓幻元科技 MCS' },
  description: '冷凍微波智能販賣機 FM 系列 3 款：55 吋廣告屏、雙微波、深冷大容量。溫控、加熱、容量與機身尺寸完整比較，數值為產品文件標示值。',
  keywords: ['冷凍微波販賣機', '會加熱的販賣機', '微波販賣機規格', '冷凍微波機比較', 'FM 系列'],
  alternates: { canonical: `${BASE}/products/frozen-vending/${SLUG}` },
  openGraph: {
    title: '冷凍微波智能販賣機 FM 系列｜3 款比較',
    description: '冷凍微波智能販賣機 FM 系列 3 款：55 吋廣告屏、雙微波、深冷大容量。溫控、加熱、容量與機身尺寸完整比較，數值為產品文件標示值。',
  ...
  return (
    <main className="min-h-screen" style={{ background: '#0B1524' }}>
      ...
      <div className="max-w-3xl mx-auto px-5 py-14">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-slate-100 leading-snug mb-4">冷凍微波智能販賣機 FM 系列：3 款型號規格比較</h1>
