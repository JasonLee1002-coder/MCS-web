...
const PLATFORM_DATA = {
  zh: {
    ...
    businessModel: {
      ...
      items: [
        { icon: "📅", label: "平台連線月費", desc: "依設備數量分階層，個案報價", type: "recurring" },
        { icon: "💰", label: "資訊及 AI 服務分潤", desc: "客戶營業額 5%—客戶越賺，MCS 越賺", type: "aligned" },
        { icon: "🔧", label: "企業客製整合費", desc: "依整合範圍個案報價，一次性深度綁定", type: "onetime" },
  ...
  en: {
    ...
    businessModel: {
      ...
      items: [
        { icon: "📅", label: "Monthly Platform Fee", desc: "Tiered by device count, quoted per case", type: "recurring" },
        { icon: "💰", label: "AI & Data Revenue Share", desc: "5% of client GMV — aligned incentives", type: "aligned" },
        { icon: "🔧", label: "Enterprise Integration Fee", desc: "Quoted per integration scope, one-time deep integration", type: "onetime" },
  ...
  ja: {
    ...
    businessModel: {
      ...
      items: [
        { icon: "📅", label: "月額プラットフォーム費", desc: "台数に応じた段階制、個別お見積り", type: "recurring" },
        { icon: "💰", label: "AI・データ収益シェア", desc: "クライアントGMVの5%——利益が一致する構造", type: "aligned" },
        { icon: "🔧", label: "エンタープライズ統合費", desc: "統合範囲に応じた個別見積り、一回限りの深度統合", type: "onetime" },
  ...
  id: {
    ...
    businessModel: {
      ...
      items: [
        { icon: "📅", label: "Biaya Platform Bulanan", desc: "Bertingkat sesuai jumlah perangkat, penawaran per kasus", type: "recurring" },
        { icon: "💰", label: "Bagi Hasil AI & Data", desc: "5% dari GMV klien — insentif yang selaras", type: "aligned" },
        { icon: "🔧", label: "Biaya Integrasi Enterprise", desc: "Penawaran sesuai lingkup integrasi, satu kali", type: "onetime" },
