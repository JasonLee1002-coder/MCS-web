...
const DATA = {
  zh: {
    ...
    clients: [
      ...
      },
      {
        ...
        color: "bg-[#7B4A1A]",
        accentColor: "#F59E0B",
        stats: ["50台 2026 H2 GraBox 首批", "多台配送車 GPS 調度", "LINE點餐→GraBox取餐 OMO"],
      },
      {
        name: "上市集團",
        badge: "特定場域 · 軍事/移工/工廠",
  ...
  en: {
    ...
    clients: [
      ...
      {
        name: "EB+ Group",
        badge: "Multiple Locations · Breakfast Chain",
        color: "bg-[#7B4A1A]",
        accentColor: "#F59E0B",
        stats: ["50 GraBox units H2 2026 (first batch)", "Multi-truck GPS fleet dispatch", "LINE order → GraBox pickup OMO"],
      },
      {
        name: "Listed Partner Group",
  ...
  ja: {
    ...
    clients: [
      ...
      },
      {
        ...
        color: "bg-[#7B4A1A]",
        accentColor: "#F59E0B",
        stats: ["50台 2026年H2 GraBox初回", "多台GPS配送車管理", "LINE注文→GraBox受取 OMO"],
      },
      {
        name: "上場会社パートナー",
        badge: "特定拠点 · 軍・寮・工場",
  ...
  id: {
    ...
    clients: [
      ...
      {
        name: "EB+ Group",
        badge: "Multi Lokasi · Rantai Sarapan",
        color: "bg-[#7B4A1A]",
        accentColor: "#F59E0B",
        stats: ["50 unit GraBox H2 2026 (batch pertama)", "Armada GPS multi-truk", "Pesan LINE → ambil GraBox OMO"],
      },
      {
        name: "Grup Mitra Tbk",
