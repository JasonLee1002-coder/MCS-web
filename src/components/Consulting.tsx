        ...
        {selected !== null && imgZoom && (
          <>
            ...
            >
              ...
              >
                <Image
                  src={CARD_META[selected].image}
                  alt={tr.items[selected].title}
                ...
                <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                  ...
                  <p className="text-white/60 text-sm mt-1">{tr.items[selected].desc}</p>
                </div>
        ...
        {selected !== null && !imgZoom && (
          <>
            ...
            <div className="fixed inset-0 z-[101] flex items-center justify-center p-6">
              <motion.div
                className={`relative w-full max-w-lg bg-gradient-to-br from-mcs-blue-dark to-[#0a1e38] rounded-3xl overflow-hidden border ${CARD_META[selected]?.border ?? "border-white/20"}`}
              ...
              >
                {/* Image — click to zoom */}
                <div
                  className="relative w-full h-48 cursor-zoom-in overflow-hidden group"
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="bg-black/50 backdrop-blur-sm border border-white/30 rounded-full px-4 py-2 flex items-center gap-2 text-white text-sm font-medium">
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${CARD_META[selected].accent} opacity-30`} />
                </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-6" staggerDelay={0.1}>
          {tr.items.map((item, i) => (
            <StaggerItem key={i}>
              <motion.button
                className="group relative w-full text-left rounded-2xl overflow-hidden cursor-pointer border border-white/10 hover:border-white/25 transition-all duration-300"
