...
export const translations: Record<Lang, Translations> = {
  zh: {
    ...
    hero: {
      ...
      headline2: "商業系統整合",
      tagline:
        "Meta Clearing Station Pte. Ltd. 以新加坡為國際總部，深度整合台灣頂尖軟硬體技術，為亞太企業提供 GraBox AI 智取櫃、冷凍微波販賣機、自助服務設備到 POS/KDS 雲端系統的一站式數位化解決方案。",
      cta1: "探索解決方案",
      cta2: "聯絡顧問",
      stat1v: "SG",
      stat1l: "新加坡總部",
    ...
    about: {
      title: "關於 MCS",
      subtitle: "新加坡立案 × 台灣技術",
      desc: "Meta Clearing Station Pte. Ltd. 於 2023 年在新加坡 ACRA 正式立案（UEN: 202316403G），以新加坡為國際營運總部，深度整合台灣頂尖軟硬體製造能力，為亞太企業提供從設備到雲端的完整數位化解決方案。",
      feat1t: "新加坡立案",
      feat1d: "ACRA 認證，合規國際營運",
      feat2t: "台灣研發製造",
      feat2d: "100% 台灣硬體，品質保證",
      feat3t: "AI 智慧驅動",
  ...
  en: {
    ...
    hero: {
      ...
      tagline:
        "Meta Clearing Station Pte. Ltd., headquartered in Singapore, integrates Taiwan's finest hardware and software expertise to deliver end-to-end digital solutions — from GraBox AI smart cabinets and frozen microwave vending machines to POS/KDS cloud systems — for enterprises across Asia-Pacific.",
      cta1: "Explore Solutions",
      cta2: "Talk to a Consultant",
      stat1v: "SG",
      stat1l: "Singapore HQ",
      stat2v: "6+",
      stat2l: "Core Solutions",
      stat3v: "AI",
      stat3l: "AI-Powered",
    },
    services: {
  ...
  ja: {
    ...
    hero: {
      ...
      tagline:
        "Meta Clearing Station Pte. Ltd.はシンガポールに国際本社を置き、台湾の優れたハードウェア・ソフトウェア技術を深く統合し、GraBox AIスマートキャビネット、冷凍電子レンジ自動販売機からPOS/KDSクラウドシステムまで、アジア太平洋地域の企業にエンドツーエンドのデジタルソリューションをご提供します。",
      cta1: "ソリューションを見る",
      cta2: "コンサルタントに相談",
      stat1v: "SG",
      stat1l: "シンガポール本社",
