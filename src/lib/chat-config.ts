...
4. **台灣製造**：品質把關嚴格，售後服務快速，不像進口機器維修要等零件
...
- 已與日本首都高速公路（Shuto Expressway）簽訂 NDA 與 MOU，共同評估導入其服務區（尚未部署，勿說成已上線）
- 24 小時無人化供應熱食
...
3. **宮廟數位功德香油箱** — 全台首創，金龍鳳凰雕刻傳統廟宇造型結合觸控螢幕、信用卡/行動支付電子功德箱，台灣客製，「有求必應」「招財開運」主題機台
...
6. **日本首都高速公路（Shuto Expressway）** — 已簽訂 NDA 與 MOU，共同評估把冷凍微波販賣機導入高速公路服務區。日方代表團 2024 年 10 月親訪台灣工廠驗證設備。⚠️ 這案還在評估階段，**不要說成已經部署或已經外銷**；規劃中的用法是旅客 24H 自助選購冷凍餐點、機台自動微波加熱出餐
